  ...
  return (
    <div className='flex flex-row justify-end md:justify-between h-[4.4rem] py-3 pl-8 border-b-2 dark:border-gray-600 pr-8 dark:bg-gray-900 dark:text-gray-200'>
      ...
      <div className='flex flex-row items-center'>
        ...
        <button id="theme-toggle" type="button" onClick={()=>setBaseTheme(prev => !prev)} className="mr-6 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700  rounded-lg text-sm p-2.5">
